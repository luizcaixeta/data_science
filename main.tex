...
\subsubsection{Mas por que $N - 1$ e não $N$?}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{images/rafico_QQ_distribuicao_normal_padrao.jpeg}
\end{figure}
...
\subsection{Nível de significância ($\alpha$)}
...
\subsection{Erro do Tipo I ($\alpha$)}
...
\subsection{Erro do Tipo II ($\beta$)}
