...
\input{preambulo}  % <-- importa o preâmbulo
...
O algoritmo do bandido multibraços é uma alternativa para testagem online que permite a explícita otimização e uma tomada de decisão mais rápida do que a abordagem tradicional ao planejamento de experimentos.
