...
no Teorema de Bayes. Seu objetivo é estimar a probabilidade de uma classe
...
\begin{itemize}
    \item Calcula-se a probabilidade posterior de cada classe:
    \[
...
Então, a probabilidade de ser spam é de 94.9\%.
